    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen py-20 px-4" style={{ backgroundColor: 'transparent' }}>
      ...
      >
        ...
        <div 
          ...
          style={{ boxShadow: '0 20px 60px rgba(212, 168, 83, 0.3), 0 0 30px rgba(212, 168, 83, 0.2)' }}
        >
          {/* Decorative corner accents */}
          <div className="absolute top-0 left-0 w-20 h-20" style={{ boxShadow: 'inset 2px 2px 10px rgba(212, 168, 83, 0.3)' }} />
          <div className="absolute top-0 right-0 w-20 h-20" style={{ boxShadow: 'inset -2px 2px 10px rgba(212, 168, 83, 0.3)' }} />
          <div className="absolute bottom-0 left-0 w-20 h-20" style={{ boxShadow: 'inset 2px -2px 10px rgba(212, 168, 83, 0.3)' }} />
          <div className="absolute bottom-0 right-0 w-20 h-20" style={{ boxShadow: 'inset -2px -2px 10px rgba(212, 168, 83, 0.3)' }} />
          ...
          <div className="text-center relative z-10 space-y-8">
            ...
            <div className="flex justify-center">
              <div className="relative w-20 h-20">
                ...
                <div className="relative w-full h-full rounded-full bg-white flex items-center justify-center" style={{ boxShadow: '0 4px 16px rgba(212, 168, 83, 0.25), inset 0 0 8px rgba(212, 168, 83, 0.1)' }}>
        ...
        >
          ...
          <div className="relative">
            ...
            <div 
              ...
              style={{ boxShadow: '0 12px 40px rgba(212, 168, 83, 0.25), 0 0 20px rgba(212, 168, 83, 0.15), 0 -4px 12px rgba(212, 168, 83, 0.2)' }}
            >
              {/* Top accent line */}
