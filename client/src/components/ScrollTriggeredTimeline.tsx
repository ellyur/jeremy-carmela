    ...
    return (
        ...
        >
            ...
            <div className="relative max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="absolute left-1/2 top-0 bottom-0 w-0.5 -translate-x-1/2" style={{ background: 'rgba(212, 168, 83, 0.3)' }}></div>
            ...
            >
                <div className="bg-card/60 backdrop-blur-sm border border-accent/30 rounded-2xl p-8 shadow-lg">
                    ...
                    <div className="inline-block border-2 border-accent rounded-lg px-4 md:px-6 py-3 bg-[#ffffff] max-w-full">
                        <p className="text-accent text-sm sm:text-base md:text-lg break-all" style={{ fontFamily: 'Telma, sans-serif' }} data-testid="text-hashtag">#MELAifetimeWithJeremy</p>
                    </div>
                </div>
            </motion.div>
            {/* Bottom Decorative */}
