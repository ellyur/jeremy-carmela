  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center md:justify-center justify-start text-center px-6 flex-grow pt-8 md:pt-0">
        ...
        {/* Names */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl text-white tracking-wide" data-testid="text-main-invitation" style={{ fontFamily: 'Telma, sans-serif', fontWeight: 400 }}>
          {animationsEnabled ? (
            <TypeAnimation
              sequence={[
                'JEREMY & CARMELA',
