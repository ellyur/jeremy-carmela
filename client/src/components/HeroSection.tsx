...
const HeroSection = ({ audioRef }: HeroSectionProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center md:justify-center justify-start text-center px-6 flex-grow pt-8 md:pt-0">
        {/* Tagline */}
        ...
        {/* Names */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl text-white tracking-wide" data-testid="text-main-invitation" style={{ fontFamily: 'Boska, serif', fontWeight: 300, fontStyle: 'italic' }}>
          {animationsEnabled ? (
            <TypeAnimation
              sequence={[
                'JEREMY & CARMELA',
