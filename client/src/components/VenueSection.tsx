  ...
  const venues = [
    {
      ...
      address: 'Lalaan, Dasmariñas City',
      image: ceremonyImage,
      mapUrl: 'https://maps.app.goo.gl/s8xgH4JxZpvQS1EJA',
      mapEmbed: 'https://www.google.com/maps?q=Iglesia+Ni+Cristo+Lalaan+Dasmarinas+City&output=embed',
      description: 'Join us as we exchange our vows of eternal love at Iglesia Ni Cristo in Dasmariñas City. This sacred place will witness the beginning of our journey together as husband and wife.',
      details: 'The ceremony begins at 2:00 PM. Please arrive early to be seated. Dress code: Formal to Semi-Formal attire.',
      startTime: '2:00 PM',
    ...
    },
    {
      ...
      mapUrl: 'https://maps.app.goo.gl/cE7bQb4oQ2e6tcmR6',
          ...
          {venues.map((venue, index) => (
            ...
            >
              ...
              <div className="relative max-w-5xl mx-auto">
                ...
                {/* Main Content Card */}
                <div className="relative bg-card rounded-xl overflow-hidden border border-border" style={{ boxShadow: '0 10px 40px rgba(212, 168, 83, 0.3), 0 0 20px rgba(212, 168, 83, 0.2)' }}>
                  {/* Header with decorative elements */}
                  <div className="relative bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 p-8">
                    {/* Decorative corners */}
                    <div className="absolute top-0 left-0 w-16 h-16" style={{ boxShadow: 'inset 2px 2px 8px rgba(212, 168, 83, 0.4)' }} />
                    <div className="absolute top-0 right-0 w-16 h-16" style={{ boxShadow: 'inset -2px 2px 8px rgba(212, 168, 83, 0.4)' }} />
                  ...
                  <div className="grid md:grid-cols-2 gap-8 px-6 md:px-8 pb-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative w-full h-64 rounded-lg overflow-hidden" style={{ boxShadow: '0 8px 32px rgba(212, 168, 83, 0.25), 0 0 16px rgba(212, 168, 83, 0.15)' }}>
                        <iframe
                          src={venue.mapEmbed}
                          width="100%"
                          height="100%"
